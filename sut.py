...
class sut(object):
    def act0(self):
        '''
        include "task_manager.py"
        '''
        self.__test.append(('''include "task_manager.py" ''',self.guard0,self.act0))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''include "task_manager.py" '''))
    ...
    def act1(self):
        ...
        '''
        self.__test.append(('''TASKMANAGER = TaskManager() ''',self.guard1,self.act1))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''TASKMANAGER = TaskManager() '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act2(self):
        ...
        '''
        self.__test.append(('''add_task("Complete project", 2) ''',self.guard2,self.act2))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''add_task("Complete project", 2) '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act3(self):
        '''
        add_task("Read a book", 1)
        '''
        self.__test.append(('''add_task("Read a book", 1) ''',self.guard3,self.act3))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''add_task("Read a book", 1) '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act4(self):
        '''
        add_task("Go to the gym", 2)
        '''
        self.__test.append(('''add_task("Go to the gym", 2) ''',self.guard4,self.act4))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''add_task("Go to the gym", 2) '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act5(self):
        ...
        display_tasks()
        '''
        self.__test.append(('''display_tasks() ''',self.guard5,self.act5))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''display_tasks() '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act6(self):
        ...
        search_tasks("book")
        '''
        self.__test.append(('''search_tasks("book") ''',self.guard6,self.act6))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''search_tasks("book") '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act7(self):
        ...
        '''
        self.__test.append(('''mark_task_as_completed(1) ''',self.guard7,self.act7))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''mark_task_as_completed(1) '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act8(self):
        ...
        get_completed_tasks()
        '''
        self.__test.append(('''get_completed_tasks() ''',self.guard8,self.act8))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''get_completed_tasks() '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act9(self):
        '''
        save_tasks("test_tasks.pkl")
        '''
        self.__test.append(('''save_tasks("test_tasks.pkl") ''',self.guard9,self.act9))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''save_tasks("test_tasks.pkl") '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act10(self):
        '''
        load_tasks("test_tasks.pkl")
        '''
        self.__test.append(('''load_tasks("test_tasks.pkl") ''',self.guard10,self.act10))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''load_tasks("test_tasks.pkl") '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act11(self):
        ...
        display_tasks()
        '''
        self.__test.append(('''display_tasks() ''',self.guard11,self.act11))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    # END INITIALIZATION CODE
        self.__SUTName = """task_manager_script"""
        self.__actions = []
        self.__names = {}
        ...
        self.__actionClasses.append('''include "task_manager.py" ''')
        self.__actionClasses.append('''TASKMANAGER = TaskManager() ''')
        self.__actionClasses.append('''add_task("Complete project", 2) ''')
        self.__actionClasses.append('''add_task("Read a book", 1) ''')
        self.__actionClasses.append('''add_task("Go to the gym", 2) ''')
        self.__actionClasses.append('''display_tasks() ''')
        self.__actionClasses.append('''search_tasks("book") ''')
        self.__actionClasses.append('''mark_task_as_completed(1) ''')
        self.__actionClasses.append('''get_completed_tasks() ''')
        self.__actionClasses.append('''save_tasks("test_tasks.pkl") ''')
        self.__actionClasses.append('''load_tasks("test_tasks.pkl") ''')
        self.__actionClasses.append('''display_tasks() ''')
        self.__dependencies = {}
        self.__dependencies['''include "task_manager.py" '''] = []
        self.__dependencies['''TASKMANAGER = TaskManager() '''] = []
        self.__dependencies['''add_task("Complete project", 2) '''] = []
        self.__dependencies['''add_task("Read a book", 1) '''] = []
        self.__dependencies['''add_task("Go to the gym", 2) '''] = []
        self.__dependencies['''display_tasks() '''] = []
        self.__dependencies['''search_tasks("book") '''] = []
        self.__dependencies['''mark_task_as_completed(1) '''] = []
        self.__dependencies['''get_completed_tasks() '''] = []
        self.__dependencies['''save_tasks("test_tasks.pkl") '''] = []
        self.__dependencies['''load_tasks("test_tasks.pkl") '''] = []
        self.__dependencies['''display_tasks() '''] = []
        self.__orderings = {}
        self.__okExcepts = {}
        self.__preCode = {}
        ...
        self.__actions.append(('''include "task_manager.py" ''',self.guard0,self.act0))
        self.__names['''include "task_manager.py" '''] = ('''include "task_manager.py" ''',self.guard0,self.act0)
        self.__actionClass['''include "task_manager.py" '''] = '''include "task_manager.py" '''
        self.__orderings['''include "task_manager.py" '''] = 1
        self.__okExcepts['''include "task_manager.py" '''] = ''''''
        
        self.__actions.append(('''TASKMANAGER = TaskManager() ''',self.guard1,self.act1))
        self.__names['''TASKMANAGER = TaskManager() '''] = ('''TASKMANAGER = TaskManager() ''',self.guard1,self.act1)
        self.__actionClass['''TASKMANAGER = TaskManager() '''] = '''TASKMANAGER = TaskManager() '''
        self.__orderings['''TASKMANAGER = TaskManager() '''] = 2
        self.__okExcepts['''TASKMANAGER = TaskManager() '''] = ''''''
        
        self.__actions.append(('''add_task("Complete project", 2) ''',self.guard2,self.act2))
        self.__names['''add_task("Complete project", 2) '''] = ('''add_task("Complete project", 2) ''',self.guard2,self.act2)
        self.__actionClass['''add_task("Complete project", 2) '''] = '''add_task("Complete project", 2) '''
        self.__orderings['''add_task("Complete project", 2) '''] = 3
        self.__okExcepts['''add_task("Complete project", 2) '''] = ''''''
        
        self.__actions.append(('''add_task("Read a book", 1) ''',self.guard3,self.act3))
        self.__names['''add_task("Read a book", 1) '''] = ('''add_task("Read a book", 1) ''',self.guard3,self.act3)
        self.__actionClass['''add_task("Read a book", 1) '''] = '''add_task("Read a book", 1) '''
        self.__orderings['''add_task("Read a book", 1) '''] = 4
        self.__okExcepts['''add_task("Read a book", 1) '''] = ''''''
        
        self.__actions.append(('''add_task("Go to the gym", 2) ''',self.guard4,self.act4))
        self.__names['''add_task("Go to the gym", 2) '''] = ('''add_task("Go to the gym", 2) ''',self.guard4,self.act4)
        self.__actionClass['''add_task("Go to the gym", 2) '''] = '''add_task("Go to the gym", 2) '''
        self.__orderings['''add_task("Go to the gym", 2) '''] = 5
        self.__okExcepts['''add_task("Go to the gym", 2) '''] = ''''''
        
        self.__actions.append(('''display_tasks() ''',self.guard5,self.act5))
        self.__names['''display_tasks() '''] = ('''display_tasks() ''',self.guard5,self.act5)
        self.__actionClass['''display_tasks() '''] = '''display_tasks() '''
        self.__orderings['''display_tasks() '''] = 6
        self.__okExcepts['''display_tasks() '''] = ''''''
        
        self.__actions.append(('''search_tasks("book") ''',self.guard6,self.act6))
        self.__names['''search_tasks("book") '''] = ('''search_tasks("book") ''',self.guard6,self.act6)
        self.__actionClass['''search_tasks("book") '''] = '''search_tasks("book") '''
        self.__orderings['''search_tasks("book") '''] = 7
        self.__okExcepts['''search_tasks("book") '''] = ''''''
        
        self.__actions.append(('''mark_task_as_completed(1) ''',self.guard7,self.act7))
        self.__names['''mark_task_as_completed(1) '''] = ('''mark_task_as_completed(1) ''',self.guard7,self.act7)
        self.__actionClass['''mark_task_as_completed(1) '''] = '''mark_task_as_completed(1) '''
        self.__orderings['''mark_task_as_completed(1) '''] = 8
        self.__okExcepts['''mark_task_as_completed(1) '''] = ''''''
        
        self.__actions.append(('''get_completed_tasks() ''',self.guard8,self.act8))
        self.__names['''get_completed_tasks() '''] = ('''get_completed_tasks() ''',self.guard8,self.act8)
        self.__actionClass['''get_completed_tasks() '''] = '''get_completed_tasks() '''
        self.__orderings['''get_completed_tasks() '''] = 9
        self.__okExcepts['''get_completed_tasks() '''] = ''''''
        
        self.__actions.append(('''save_tasks("test_tasks.pkl") ''',self.guard9,self.act9))
        self.__names['''save_tasks("test_tasks.pkl") '''] = ('''save_tasks("test_tasks.pkl") ''',self.guard9,self.act9)
        self.__actionClass['''save_tasks("test_tasks.pkl") '''] = '''save_tasks("test_tasks.pkl") '''
        self.__orderings['''save_tasks("test_tasks.pkl") '''] = 10
        self.__okExcepts['''save_tasks("test_tasks.pkl") '''] = ''''''
        
        self.__actions.append(('''load_tasks("test_tasks.pkl") ''',self.guard10,self.act10))
        self.__names['''load_tasks("test_tasks.pkl") '''] = ('''load_tasks("test_tasks.pkl") ''',self.guard10,self.act10)
        self.__actionClass['''load_tasks("test_tasks.pkl") '''] = '''load_tasks("test_tasks.pkl") '''
        self.__orderings['''load_tasks("test_tasks.pkl") '''] = 11
        self.__okExcepts['''load_tasks("test_tasks.pkl") '''] = ''''''
        
        self.__actions.append(('''display_tasks() ''',self.guard11,self.act11))
        self.__names['''display_tasks() '''] = ('''display_tasks() ''',self.guard11,self.act11)
        self.__actionClass['''display_tasks() '''] = '''display_tasks() '''
        self.__orderings['''display_tasks() '''] = 12
        self.__okExcepts['''display_tasks() '''] = ''''''
